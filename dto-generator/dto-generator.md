...
In this case you need a mutable DTO with the same parameters as in the example above, JPA Buddy will add **`@Data`**,**`@AllArgsConstructor`** and **`@NoArgsConstructor`** annotations instead.
